   ...
   <!DOCTYPE html>
    <html>
        <head>
            ...
            <title>HandTalk | Smart Device</title>
            <style>
                * {
                    padding: 0;
                    margin: 0;
            ...
            <section class="main">
                <div class="page-header">
                    <div class="page-header__top">
                        <h1 class="slogan">
                            HandTalk - Your Personalized Gateway to a Beautiful Life.
                        </h1>
                    </div>
            ...
            <script>
                document.onreadystatechange = function () {
                    if (document.readyState == "complete") {
                        ...
                        function response() {
                            if (talkingCheckbox.checked) {
                                fetch("http://192.168.40.200/SEND_TEXT_SIGN")
                                    .then((resu) => resu.text())
                                    .then((data) => {
                                        signText = data;
                                        handleShowSignText(signText);
